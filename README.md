...
|-----------------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|
| RAW             | ✅         | ```quill.async().raw().method(RETRIEVE_DATA).query("SELECT * FROM example WHERE column > ?").param(10)```                                           | ```SELECT * FROM example WHERE column > 10```                                                        |
...
| ALTER TABLE     | ✅         | ```quill.async.alterTable().name("table_name").add(Column)```                                                                                       | ```ALTER TABLE table_name ADD COLUMN column_data```                                                  |
| DESCRIBE        | ✅         | ```quill.async.describe().name("table_name")```                                                                                                     | ```DESCRIBE table_name```                                                                            |
| GRANT           | ❌         |                                                                                                                                               |                                                                                                |
| REVOKE          | ❌         |                                                                                                                                               |                                                                                                |
