...
public class ModelHandler {
    ...
    public static final Map<Class<?>, Function<Field, String>> FIELD_TYPE_MAPPER = new ConcurrentHashMap<>();
    ...
    public CompletableFuture<Boolean> updateSpecific(QuillProperties properties, Plaster plaster, Object entity, RowIdentifier identifier, String... fields) throws NoSuchFieldException, IllegalAccessException {
        ...
        if (!minimum) {
            throw new QuillException("Cannot update with those fields! Either the set is empty or you passed autogenerated columns.");
        }
